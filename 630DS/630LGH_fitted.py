...
def process_lgh():
    ...
    base_out = Path(r"D:\VC\PIA\630DS\630LGH\Fitted")
    ...
    print(f"Iniciando extracción LGH (Fitted) para {len(tiff_files)} imágenes...")
    ...
    for img_path in tiff_files:
        try:
            ...
            for x_start in range(w - w_width + 1):
                ...
                #Frame Normalization (BUG CORREGIDO: era feature_vector)
                eps = 1e-7
    ...
    print(f"\nLGH Fitted completada en {base_out}")
