...
def process_lgh():
    ...
    base_out = Path(r"D:\VC\PIA\630DS\630LGH\Unfitted")
    ...
    print(f"Iniciando extracción LGH (Unfitted) para {len(tiff_files)} imágenes...")
    ...
    for img_path in tiff_files:
        try:
            ...
            # 4. Sliding Window & Unfitted Grid
            word_features = []
    ...
    print(f"\nLGH Unfitted completada en {base_out}")
